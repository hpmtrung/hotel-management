...
import profile, { getAppProfile } from './application-profile';
...
describe('Profile reducer tests', () => {
  ...
  describe('Common tests', () => {
    ...
    it('should return the right payload in prod', () => {
      ...
      expect(profile(undefined, { type: getAppProfile.fulfilled.type, payload })).toEqual({
  ...
  describe('Actions', () => {
    ...
    it('dispatches GET_SESSION_PENDING and GET_SESSION_FULFILLED actions', async () => {
      const expectedActions = [
        {
          type: getAppProfile.pending.type,
        },
        {
          type: getAppProfile.fulfilled.type,
          payload: resolvedObject,
        },
      ];
      await store.dispatch(getAppProfile());
